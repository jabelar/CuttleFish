// this script is similar to the general state physics, but for enemies with simpler states
...
switch state
    {
    case STANDING: scrProcessCharStanding() ; break ;
    case FALLING: scrProcessCharFalling() ; break ;
    case DYING: scrProcessCharDying() ; break ;
    case WALKING: scrProcessCharWalkingDumb() ; break ;
    case FLYING: scrProcessCharFlying() ; break ;
    }
